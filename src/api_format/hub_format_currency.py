...
class FormatCurrency:
    def __init__(self,root):
        ...
        self.currency_scale = tk.Scale(self.currency_bg, bg="#7EDCFF",from_=0,to=500,tickinterval=50,length=500,orient="horizontal",command=self.get_val)
        self.scale_text = tk.Label(self.currency_scale,bg="#7EDCFF",text="Try a different amount!",font=("helvetica",15))
