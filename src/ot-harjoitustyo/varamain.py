...
import requests
from ui.home_ui import HomeScreenUI
...
class HomeFrame(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.canvas.pack()
        load_ui = HomeScreenUI()
        load_ui.do_that(self.root)
...
class MainFrame():
    ...
    def format_weather(self, got_weather):
        ...
        four_weather_day_text = tk.Label(four_box,
             ...
             font=("helvetica", 13), bg="lightblue")
        four_weather_min_text = tk.Label(four_box,
             text=f"Daily min.: {four_weather_min}°C",
             font=("helvetica", 13), bg="lightblue")
        four_date_text = tk.Label(four_box,
             text=f"Date: {four_date}",
             font=("helvetica", 13), bg="lightblue")
...
class StartClass:
    def start(self):
        alkuroot = tk.Tk()
        HomeFrame(alkuroot).pack(side="top", fill="both", expand=True)
        alkuroot.mainloop()
